...
final Color kPrimary = '#080108'.toColor();
final Color kSecondary = '#F662FF'.toColor();
final Color kPrimaryMedium = '#FCFCFC'.toColor();
final Color kBackground = '#B9B7B8'.toColor();
final Color kpicBg = '#444444'.toColor();
